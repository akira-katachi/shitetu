...
<body>
	<div id="content">
		...
		<table>
			<tr>
				<td class="xa">入力内容をご確認の上、「この内容で登録する」ボタンをクリックしてください。</td>
			</tr>
			<tr>
		...
		<table class="cca">
			...
			<table class="cca">
				<form method="post" action="h3_branch.php">
					<input name="zigyousya" type="hidden"
						value="<?php print $zigyousya ?>"> <input name="yuubinbangou"
						type="hidden" value="<?php print $yuubinbangou ?>"> <input
						name="todouhuken" type="hidden" value="<?php print $todouhuken ?>">
					<input name="tyouiki" type="hidden" value="<?php print $tyouiki ?>">
					<input name="denwabangou" type="hidden"
						value="<?php print $denwabangou ?>"> <input name="faxbangou"
						type="hidden" value="<?php print $faxbangou ?>"> <input name="hp"
						type="hidden" value="<?php print $hp ?>"> <input name="daihyousya"
						type="hidden" value="<?php print $daihyousya ?>"> <input
						name="syokumei" type="hidden" value="<?php print $syokumei ?>"> <input
						name="zigyousyo" type="hidden" value="<?php print $zigyousyo ?>">
					<input name="kaigos" type="hidden" value="<?php print $kaigos ?>">
					<input name="zigyousyoba" type="hidden"
						value="<?php print $zigyousyoba ?>"> <input name="yuubinbangou2"
						type="hidden" value="<?php print $yuubinbangou2 ?>"> <input
						name="todouhuken2" type="hidden"
						value="<?php print $todouhuken2 ?>"> <input name="tyouiki2"
						type="hidden" value="<?php print $tyouiki2 ?>"> <input
						name="zenwabangou2" type="hidden"
						value="<?php print $zenwabangou2 ?>"> <input name="FAX2"
						type="hidden" value="<?php print $FAX2 ?>"> <input
						name="zigyoukaisi" type="hidden"
						value="<?php print $zigyoukaisi ?>"> <input name="sabisunaiyou"
						type="hidden" value="<?php print $sabisunaiyou ?>"> </br>
					<div class="pattern2a">
						<td><a href="#" onClick="document.location='h1.php';"
							class="square_btna">修正する</a></td>
					</div>
					<div class="pattern3a">
