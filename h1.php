		...
		<table border="1">
			<form method="post" action="h1_branch.php">
				<tr>
					...
					<td class="q"><input type="text" name="zigyousya" value=""
						class="ba"></td>
				</tr>
				<tr>
					<td rowspan="3" class="ab">住所</td>
					<td class="ac">郵便番号</td>
					<td class="q"><input type="text" name="yuubinbangou" value=""
						class="bb"><a class="bba">※入力されると住所が自動的に入力されます。</a></td>
				</tr>
				<tr>
					<td class="ac">都道府県・市区町村</td>
					<td class="q"><input type="text" name="todouhuken" value=""
						class="bc"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ac">電話番号</td>
					<td class="q"><input type="text" name="denwabangou" value=""
						class="bb"></td>
				</tr>
				<tr>
					<td class="ac">FAX番号</td>
					<td class="q"><input type="text" name="faxbangou" value=""
						class="bd"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="q"><input type="text" name="daihyousya" value=""
						class="be"></td>
				</tr>
				<tr>
					<td colspan="2" class="aa">代表者職名</td>
					<td class="q"><input type="text" name="syokumei" value=""
						class="be"></td>
				</tr>
