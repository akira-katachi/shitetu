...
<?php }?>
			...
			<table class="cca">
				<form method="post" action="kensaku＿h1_branch.php">
					<input name="code" type="hidden" value="<?php print $code ?>"> <input
						name="zigyousya" type="hidden"
						value="<?php print $row['zigyousya'] ?>"> <input
						name="yuubinbangou" type="hidden"
						value="<?php print $row['yuubinbangou'] ?>"> <input
						name="todouhuken" type="hidden"
						value="<?php print $row['todouhuken'] ?>"> <input name="tyouiki"
						type="hidden" value="<?php print $row['tyouiki'] ?>"> <input
						name="denwabangou" type="hidden"
						value="<?php print $row['denwabangou'] ?>"> <input
						name="faxbangou" type="hidden"
						value="<?php print $row['faxbangou'] ?>"> <input name="hp"
						type="hidden" value="<?php print $row['hp'] ?>"> <input
						name="daihyousya" type="hidden"
						value="<?php print $row['daihyousya'] ?>"> <input name="syokumei"
						type="hidden" value="<?php print $row['syokumei'] ?>"> <input
						name="zigyousyo" type="hidden"
						value="<?php print $row['zigyousyo'] ?>"> <input name="kaigos"
						type="hidden" value="<?php print $row['kaigos'] ?>"> <input
						name="zigyousyoba" type="hidden"
						value="<?php print $row['zigyousyoba'] ?>"> <input
						name="yuubinbangou2" type="hidden"
						value="<?php print $row['yuubinbangou2'] ?>"> <input
						name="todouhuken2" type="hidden"
						value="<?php print $row['todouhuken2'] ?>"> <input name="tyouiki2"
						type="hidden" value="<?php print $row['tyouiki2'] ?>"> <input
						name="zenwabangou2" type="hidden"
						value="<?php print $row['zenwabangou2'] ?>"> <input name="FAX2"
						type="hidden" value="<?php print $row['FAX2'] ?>"> <input
						name="zigyoukaisi" type="hidden"
						value="<?php print $row['zigyoukaisi'] ?>"> <input
						name="sabisunaiyou" type="hidden"
						value="<?php print $row['sabisunaiyou'] ?>"> </br>
					<div class="pattern2a">
						<td><a href="#" onClick="document.location='kensaku_p.php';"
							class="square_btna">戻る</a></td>
					</div>
					<div class="pattern3a">
