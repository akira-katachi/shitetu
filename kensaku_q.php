...
<body>
	<table>
		<td><h1 class="k">ユーザー情報編集</h1></td>
	</table>
	<table>
		<form action="kensaku_q.php" method="post" class="fg">
			<td>事業者名<input type="text" name="zigyousya"> 住所<input type="text"
				name="todouhuken"> <input type="submit" value="検索する"></td>
		</form>
...
<tr>
				<td><?=$row['code']?></td>
				<td class="code"><?=htmlspecialchars($row['zigyousya'],ENT_QUOTES,'UTF-8')?></td>
				<td class="zigyousya"><?=htmlspecialchars($row['todouhuken'],ENT_QUOTES,'UTF-8')?></td>
				<td class="denwabangou"><?=htmlspecialchars($row['denwabangou'],ENT_QUOTES,'UTF-8')?></td>
